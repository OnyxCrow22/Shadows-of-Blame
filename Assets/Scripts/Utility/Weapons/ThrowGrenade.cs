...
public class ThrowGrenade : MonoBehaviour
{
    ...
    // Called when the script is initially enabled
    public void OnEnable()
    {
        // Allows the user to throw a grenade when the grenade action is performed
        grenadeAction.action.performed += OnGrenade;
    }

    public void OnDisable()
    {
        // Prevents the user from throwing a grenade.
        grenadeAction.action.performed -= OnGrenade;
    }
